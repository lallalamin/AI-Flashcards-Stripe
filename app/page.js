        ...
        <Box sx={{textAlign: 'center'}}>
          <div className="welcome-bg">
            <Typography className="welcome-title" variant="h3" component="h1" gutterBottom>
              Master your learning with lightning-fast flashcards generation!
            </Typography>
        ...
        <Grid container spacing={4} justifyContent="center">
          <Grid item xs={12} md={4}>
            <Box sx={{
              ...
              <Button variant="contained" color="primary" sx={{ mt: 2}} onClick={handleSubmit5}>
                Choose basic
              </Button>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box sx={{
              ...
              <Button variant="contained" color="primary" sx={{ mt: 2}} onClick={handleSubmit10}>
                Choose pro
              </Button>
            </Box>
          </Grid>
